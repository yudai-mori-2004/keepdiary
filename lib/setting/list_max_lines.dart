...
class ListMaxLinesSetting extends HookConsumerWidget {
  const ListMaxLinesSetting({Key? key}) : super(key: key);
                  ...
                  SizedBox(
                      ...
                      DropdownButton(
                        ...
                        onChanged: (value) {
                          ...
                          settingData.listMaxLinesProvider=int.parse(value.toString());
