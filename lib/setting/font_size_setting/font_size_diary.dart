...
class FontSizeDiarySetting extends HookConsumerWidget {
  const FontSizeDiarySetting({Key? key}) : super(key: key);
                  ...
                  SizedBox(
                      ...
                      DropdownButton(
                        ...
                        onChanged: (value) {
                          ...
                          settingData.fontSizeDiaryProvider=int.parse(value.toString());
